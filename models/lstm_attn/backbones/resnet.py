...
class ResNet(nn.Module):
    ...
    def __init__(self, arch, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # Alex: 512 in ResNet18
        if self.arch == 'resnet18' or self.arch == 'resnet34':
           self.out_channels = self.layer4[-1].bn2.num_features
        elif self.arch == 'resnet50' or self.arch == 'resnext50_32x4d' or self.arch == 'resnext101_32x8d':
           self.out_channels = self.layer4[-1].bn3.num_features       
