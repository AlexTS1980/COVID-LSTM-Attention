...
from .generalized_rcnn_attention import GeneralizedRCNNAttention
from .rpn import AnchorGenerator, RPNHead, RegionProposalNetwork
from .roi_heads_mask_features import RoIHeads
...
class FasterRCNN(GeneralizedRCNNAttention):
    """
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        super(FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform, **kwargs)
